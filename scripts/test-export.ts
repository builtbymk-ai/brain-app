...
check('owner: 13 columns in header (V2B.3 adds RevenueStatus)', ownerLines[0].split(',').length === 13);
check('owner: RevenueStatus column present', ownerLines[0].includes('RevenueStatus'));
check(
